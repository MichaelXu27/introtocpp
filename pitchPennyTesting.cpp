...
void bearPrize(string a[][c])
{
	int randRow = rand() % 5;
	int randCol = rand() % 5;
	
	if(a[randRow][randCol] == "📦")
	{
		a[randRow][randCol] = "✨";
	}
	else
...
void fishPrize(string a[][c])
{
	int randRow = rand() % 5;
	int randCol = rand() % 5;
	
	if(a[randRow][randCol] == "️📦")
	{
		a[randRow][randCol] = "🐟";
	}
	else
